    ...
    <div class="d-flex gap-2">
        <div class="btn-group" role="group">
            ...
            <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="../../modules/export/export.php?type=residents&format=pdf" target="_blank">
                    <i class="bi bi-file-earmark-pdf me-2 text-danger"></i> Export as PDF
                </a></li>
                <li><a class="dropdown-item" href="../../modules/export/export.php?type=residents&format=excel" target="_blank">
                    <i class="bi bi-file-earmark-spreadsheet me-2 text-success"></i> Export as Excel
                </a></li>
                <li><a class="dropdown-item" href="../../modules/export/export.php?type=residents&format=docx" target="_blank">
